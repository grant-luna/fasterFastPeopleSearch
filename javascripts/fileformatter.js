export class FileFormatter {
  ...
  static processFidelityTotalFarmRow(row) {
    ...
    return {
      ...
      'Site Address': `${row["Site Address House Number"]} ${row["Site Address Street Prefix"]} ${row["Site Address Street Name"]} ${row["Site Address City"]}, ${row["Site Address State"]} ${row["Site Address Zip+4"]}`.replace(/^null$/g, ''),
